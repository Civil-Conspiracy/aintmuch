...
<tileset version="1.8" tiledversion="1.8.4" name="forest-tileset-test" tilewidth="16" tileheight="16" tilecount="64" columns="8">
 ...
 <tile id="27">
  <properties>
   <property name="unity:SortingLayer" value="Background"/>
   <property name="unity:SortingOrder" type="int" value="-14"/>
  </properties>
  <objectgroup draworder="index" id="2">
 ...
 <tile id="28">
  <objectgroup draworder="index" id="2">
   <object id="2" x="0" y="0" width="6" height="4"/>
  </objectgroup>
 </tile>
 <tile id="35">
  <objectgroup draworder="index" id="2">
